...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button group/menu-button relative isolate flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm ring-sidebar-ring outline-hidden transition-[width,height,padding,transform,background-color,color,box-shadow] duration-200 ease-out before:absolute before:inset-y-1 before:left-0 before:w-0.5 before:origin-center before:scale-y-0 before:rounded-full before:bg-primary before:opacity-0 before:transition-[transform,opacity] before:duration-200 group-has-data-[sidebar=menu-action]/menu-item:pr-8 group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! hover:translate-x-0.5 hover:!bg-sidebar-accent/70 hover:text-sidebar-foreground hover:shadow-[0_8px_18px_-14px_rgb(0_0_0_/_0.72)] hover:before:scale-y-100 hover:before:opacity-100 focus-visible:ring-2 active:translate-x-px active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-open:hover:bg-muted data-open:hover:text-sidebar-foreground data-active:bg-sidebar-accent data-active:font-medium data-active:text-sidebar-accent-foreground data-active:shadow-[0_8px_18px_-14px_rgb(0_0_0_/_0.72)] data-active:before:scale-y-100 data-active:before:opacity-100 data-active:hover:bg-sidebar-accent data-active:hover:text-sidebar-accent-foreground [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:transition-[transform,color] [&_svg]:duration-200 group-hover/menu-button:[&_svg]:scale-110 data-active:[&_svg]:text-primary [&>span:last-child]:truncate',
  {
    variants: {
      variant: {
